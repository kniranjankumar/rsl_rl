...
class MultiSkillActorCritic(nn.Module):
    def __init__(self,
        ...
        self.weights = Weights([256,256], actor_obs_size[-1], num_skills, activation)
    ...
    def update_distribution(self, observations):
        ...
        self.residual_action_magnitude = torch.norm(skill_means[-1],dim=1).mean()
